...
#define ID_SPRITE_GROUND_BEGIN (ID_SPIRTE_GROUND + 1000)
#define ID_SPRITE_GROUND_MIDDLE (ID_SPIRTE_GROUND + 2000)
#define ID_SPRITE_GROUND_END (ID_SPIRTE_GROUND + 3000)
